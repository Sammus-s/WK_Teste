...
begin
  ...
  DM.QueryProdutosPedidos.SQL.Add('SELECT * FROM pedidos_produtos INNER JOIN produtos ON');
  DM.QueryProdutosPedidos.SQL.Add('produtos.codigo = pedidos_produtos.codigo_produto');
  DM.QueryProdutosPedidos.SQL.Add('WHERE numero_pedido = :pNumeroPedido');
  ...
  begin
    ...
    descProduto := DM.QueryProdutosPedidos.FieldByName('descricao').AsString;
